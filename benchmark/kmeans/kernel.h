...
#define OFF_PCENTROIDS(x, y)  ((OFF_DIMENSION + SIZE_DIMENSION) + (x)*(y)*sizeof(float))
#define OFF_PPOPULATION(x, y) ((OFF_PCENTROIDS(0, MAX_DIMENSION) + SIZE_PCENTROIDS) + (x)*(y)*sizeof(float))
